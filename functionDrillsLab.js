...
//CODE HERE
const compareNums = (num1,num2) =>{let answer = num1 >= num2 ? num1 : num2; return answer;}
console.log(compareNums(81,10))
////////////////// PROBLEM 6 ////////////////////
/*
...
let nameGreeting = nameCheck("King");
...
//CODE HERE
function oneArgument(sampleStr){
  String(sampleStr);
  return `${sampleStr.toUpperCase()}`
}console.log(oneArgument(sampleString))
...
console.log(emailCheck("            kvng@yahoo.com"))
...
//CODE HERE
function buyFrogs(amountSpent){
  return `Math.floor(${amountSpent / 3}) Chocolate frogs.`
}
const totalFrogs = buyFrogs(58);
...
} let arrayIsAscending = arrayNum(sampleArray);
